...
declare global {
  ...
  const defaultAxis: typeof import('./composables/useECharts')['defaultAxis']
  const defaultDataZoom: typeof import('./composables/useECharts')['defaultDataZoom']
  const defaultProps: typeof import('./composables/useECharts')['defaultProps']
  const defaultTimeAxis: typeof import('./composables/useECharts')['defaultTimeAxis']
  ...
  const useChartGlobalOption: typeof import('./composables/useECharts')['useChartGlobalOption']
  const useCssModule: typeof import('@vue/composition-api')['useCssModule']
  const useDefaultOption: typeof import('./composables/useECharts')['useDefaultOption']
